...
public class PersonneServiceImpl implements PersonneService {
    ...
    @Override
    public List<PersonneDto1> getAll(String username) {
        List<Personne> personne = personneRepo.listByUsername(username);
        return personne.stream().map(personneMapper::entityToDto1).toList();
    }
}
